...
class List_Term_Object(object):
      ...
      def __init__(self,line,raw_mode,SEPERATE_CHAR,mongoObj,w2vmodel,is_bigram_used=False):
          self.str=line.strip()
          self.get_term(raw_mode,SEPERATE_CHAR)
          #self.update_term(mongoObj,w2vmodel)
          self.update_term_freq()
          if is_bigram_used==True:
      ...
      def update_term(self,mongoObj,w2vmodel):
          ...
          for i in range(len_t):
              ...
              if WORD_EMBEDDING_TYPE!='NONE' and w2vmodel!=NONE:
